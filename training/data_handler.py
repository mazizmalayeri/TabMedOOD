...
def split_data(in_features_np, in_label_np, train_size=0.7, random_state=0, handle_imbalance_data=False, train_test_labels = None):
    """
    ...
    if train_test_labels is None:
        ...
        X['train'], X['test'], y['train'], y['test'] = in_features_np[train_test_labels == 'train'], in_features_np[train_test_labels == 'test'], in_label_np[train_test_labels == 'train'], in_label_np[train_test_labels == 'test']
